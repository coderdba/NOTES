##
##  FROM: https://github.com/oracle/docker-images/blob/master/OracleInstantClient/oraclelinux7/19/Dockerfile
##
...
#      $ docker run -ti --rm oracle/instantclient:19 sqlplus -l hr@example.com/orclpdb1
#
# NOTES
# -----
#
