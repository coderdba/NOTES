...
Note: Each row's json is again enclosed in double quotes
...
Note: results in an array or sql-array enclosed in {}. Each element is a "{}" - note the double quotes. Inside "{}" it will be name:value pairs of jsons.
...
Note: results in a json array enclosed in [].  Each element in it is a {} without double quotes. json of each row is treated as an element of an outer json.
